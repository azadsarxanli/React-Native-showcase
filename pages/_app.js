...
function MyApp({ Component, pageProps }) {
  return (
    <>
      <Head>
        <title>ProNef Marketplace</title>
        <link rel="icon" href="/favicon.ico" />

        <meta
          name="description"
          content="Buy, store, collect NFTs, exchange & earn crypto. Join 25+ million using ProNef Marketplace."
        />

        <meta property="og:title" content="ProNef Marketplace" />
        <meta
          property="og:description"
          content="Buy, store, collect NFTs, exchange & earn crypto. Join 25+ million using ProNef Marketplace."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://pronft.com/" />
        <meta property="og:image" content="/assets/home_hero.png" />
      </Head>
      <Component {...pageProps} />
    </>
  );
